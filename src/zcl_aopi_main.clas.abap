CLASS zcl_aopi_main DEFINITION PUBLIC.
  ...
  PRIVATE SECTION.
    METHODS operation_implementation
      IMPORTING is_operation TYPE zif_aopi_schema=>ty_operation
      RETURNING VALUE(rv_abap) TYPE string.

    METHODS parameters_to_abap
      IMPORTING it_parameters TYPE zif_aopi_schema=>ty_parameters
      RETURNING VALUE(rv_abap) TYPE string.

    METHODS build_class
      IMPORTING
      iv_interface_name TYPE string
      it_operations TYPE zif_aopi_schema=>ty_operations
      RETURNING VALUE(rv_abap) TYPE string.
...
CLASS zcl_aopi_main IMPLEMENTATION.
  ...
  METHOD build_class.
    ...
    DATA ls_parameter TYPE zif_aopi_schema=>ty_parameter.
