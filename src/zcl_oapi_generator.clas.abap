CLASS zcl_oapi_generator DEFINITION PUBLIC.
  PUBLIC SECTION.
    CLASS-METHODS generate_v1
      IMPORTING
        is_input         TYPE zcl_oapi_main=>ty_input
      RETURNING
        VALUE(rs_result) TYPE zcl_oapi_main=>ty_result.

    CLASS-METHODS generate_v2
      IMPORTING
        is_input         TYPE zcl_oapi_generator_v2=>ty_input
      RETURNING
        VALUE(rs_result) TYPE zcl_oapi_generator_v2=>ty_result.
ENDCLASS.
