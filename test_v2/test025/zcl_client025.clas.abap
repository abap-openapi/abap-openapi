CLASS zcl_client025 DEFINITION PUBLIC.
...
CLASS zcl_client025 IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ...
  METHOD zif_interface025~search_v2.
    ...
    lv_uri = mv_uri_prefix && '/{configId}/searches'.
    REPLACE FIRST OCCURRENCE OF '{configId}' IN lv_uri WITH config_id.
